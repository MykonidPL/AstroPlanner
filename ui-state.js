/* AstroPlanner v0.14 — persistent shell state; Planner workspace, Journal browsing and recommendations are intentionally transient */
(()=>{
  'use strict';
  ...
  const writeJson=(key,value)=>{try{localStorage.setItem(key,JSON.stringify(value));}catch(e){console.warn('AstroUI persistence',e);}};
  ...
  /* v0.14 — final Planner placement + intentionally minimal home screen. */
