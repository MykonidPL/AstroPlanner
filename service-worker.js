...
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./zwo-cameras.json','./framing-engine.js','./star-layer.js','./dso-layer.js','./framing-renderer.js','./raster-layer.js'];
